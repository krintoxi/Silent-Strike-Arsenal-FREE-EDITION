...
print" e.g.: asp, php, cfm, all\n";
print" If you don't know the launguage used in the coding then simply type ** all ** \n";
print"--> ";
$code=<STDIN>;
chomp($code);
...
print "->Target: $site\n";
print "->Website Code Being Tested: $code\n";
print "->Scan of the admin control panel is ongoing...\n\n\n";
