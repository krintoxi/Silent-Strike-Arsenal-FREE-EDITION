...
def validate_password():
    ...
    if entered_password == "FREECUBA":
        ...
        for widget in script_buttons[:3]:  # Only the first four script buttons should be enabled
            widget['state'] = 'normal'
        ...
        for button in script_buttons[3:]:  # Apply this to buttons from the fifth onwards
